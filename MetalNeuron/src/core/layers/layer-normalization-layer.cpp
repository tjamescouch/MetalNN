...
LayerNormalizationLayer::LayerNormalizationLayer(int inputDim, int outputDim, int batchSize, int _unused, float learningRate, float epsilon)
: inputDim_(inputDim),
...
int LayerNormalizationLayer::outputSize() const {
    return outputDim_;
}
